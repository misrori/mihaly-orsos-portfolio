  ...
  return (
    <footer id="contact" className="border-t border-border bg-card/50 py-12">
      <div className="container px-6 text-center">
        ...
        <a href="mailto:goldhand@goldhand.space" className="text-lg text-foreground transition-colors hover:text-primary">
          {t("contact.email")}
        </a>
        <div className="mt-6 flex items-center justify-center gap-4">
          ...
          <a href="mailto:goldhand@goldhand.space" className="text-muted-foreground hover:text-primary"><Mail size={20} /></a>
        </div>
